...
const PricingTable = (props) => {
                                                    ...
                                                    <div className="block sm:flex md:block lg:flex items-center justify-center">
                                                        ...
                                                        <div className="mt-4 mb-8 sm:m-8 md:m-0 md:mt-4 md:mb-8 lg:m-8 text-center">
                                                            <div className="inline-flex items-center">
                                                                ...
                                                                <span className="text-xl ml-2">per month</span>
                                                            </div>
    ...
    if (type === "single") {
        return (
            <div className="antialiased max-w-6xl mx-auto my-6 px-8">
                                            <div className="relative block md:flex items-center">
                                                <div className="w-full md:w-1/2 relative z-1 bg-gray-100 rounded shadow-xl overflow-hidden">
                                                    <div className="text-lg font-medium uppercase p-8 text-center border-b border-gray-200 tracking-wide">
                                                        One Time Payment
                                                    </div>
                                                    <div className="block sm:flex md:block lg:flex items-center justify-center">
